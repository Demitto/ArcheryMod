...
public class RenderCompoundBow implements IItemRenderer {
  ...
  public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
      ...
      Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation(ProjectileTutorialCore.MODID, "textures/Compound_bow.png"));
      //Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("/assets/archery/textures/archery.png"));
      ProjectileTutorialCore.mcgunsmodelcompound.renderAll();
	  GL11.glPopMatrix();
	  break;
          }
