...
{
    private static final ResourceLocation bulletTextures = new ResourceLocation(ProjectileTutorialCore.MODID, "textures/white.png");
    ...
    {
        BulletModel model = (BulletModel) this.modelBullet;
